...
const RoomDetails = () => {
  ...
  return room && (
    <div className='py-28 md:py-35 px-4 md:px-16 lg:px-24 xl:px-32'>
         ...
         <form className='flex flex-col md:flex-row items-start md:items-center justify-between bg-orange-50 shadow-  [0px_0px_20px_rgba(0,0,0,0.15)] p-6 rounded-xl mx-auto mt-16 max-w-6xl'>
        ...
        <div className='flex flex-col items-start gap-4'>
            <div className='flex gap-4'>
               <img src={assets.guestsIcon} alt="Host" className='h-14 w-14 md:h-18 md:w-18 rounded-full'/>
               <div>
